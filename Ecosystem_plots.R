...
png(file ="importanceplots_v2.0_15a_lowres.png", width = 600, height = 800, units = "mm", res = 200)
...
#######Spcumplot##############
png(file ="SpCompExploitation_1_v2.0_01.png", width = 173.5, height = 173.5, units = "mm", res = 600)
...
png(file ="totalCompLandings_v2.0_01.png", width = 173.5, height = 173.5, units = "mm", res = 600)
# tiff(file = paste0(figure.dir, "PIE-cumImportanceSplit_v05.tiff"), width = 173.5, height = 173.5, units = "mm", res = 1000)
...
NEUS.a.thresh<-NEUS.d[c(7,8,9),c("Population", "Seafood", "Landings", "Exploitation", "SST",  "MEI", "AMO", "Exploitation_1", "Landings_1",
                                  "Chlorophyll", "Freshwater", "GDP")]
PI.a.thresh<-PI.d[c(7,8,9),c("Population", "Seafood", "Landings", "SST",  "MEI", "PDO", "Landings_1", "GDP", "Chlorophyll")]
...
rownames(Population)<-c("Upper", "Mean", "Lower", "Threshold1", "Threshold2", "Threshold3")
